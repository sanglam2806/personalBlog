    ...
    <div className='mt-2 mb-8 grid grid-cols-12 h-[42vw]' 
        ...
        <div className='flex items-center ml-2 col-span-6'>
            <div>
                ...
                <p className='block ml-1 text-sm md:text-xl lg:text-2xl'>僕の世界へよろこそ！ミツルと言います</p>
                <p className='block ml-1 text-sm md:text-xl lg:text-2xl'>日本にいる撮影が好きのベトナム人です</p>
                <p className='block ml-1 text-sm md:text-xl lg:text-2xl'>ここに来た所、出会った人などについて</p>
                <p className='block ml-1 text-sm md:text-xl lg:text-2xl'>写真で自分の日本の生活を語ります</p>
                <p className='block ml-1 text-sm md:text-xl lg:text-2xl'>観てくださる方の心が、少しでも温かくなるような嬉しいです</p>
            </div>
        </div>
    </div>
  )
