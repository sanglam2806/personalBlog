    ...
    <div className='mt-2 mb-8 grid grid-cols-12 lg:h-[42vw] md:h-[46vw] sm:h-[49vw]' 
        ...
        <div className='flex items-center ml-2 col-span-6 sm:mr-1'>
            <div>
                ...
                <p className='block ml-1 text-xs md:text-base lg:text-2xl'>僕の世界へようこそ！ミツルです.</p>
                <p className='block ml-1 text-xs md:text-base lg:text-2xl'>日本に住む写真撮影好きのベトナム人です.</p>
                <p className='block ml-1 text-xs md:text-base lg:text-2xl'>ここ日本での体験、行った場所、出会った人、日本での生活</p>
